/**
 * Configuration Vue Router - Gestion de la navigation
 * Définit toutes les routes de l'application et les gardes de navigation
 * Gère l'authentification et les redirections selon le statut utilisateur
 */
